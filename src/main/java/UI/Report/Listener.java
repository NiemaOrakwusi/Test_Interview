...
import com.relevantcodes.extentreports.LogStatus;
    ...
    public class Listener implements ITestListener {
        ...
        public void onTestFailure(ITestResult result) {
            ...
            try {
                FileUtils.copyFile(src, new File(System.getProperty("user.dir") + "/src/main/resources/" + result.getMethod().getMethodName() + ".png"));
                String file = test.addScreenCapture(System.getProperty("user.dir") + "/src/main/resources/" + result.getMethod().getMethodName() + ".png");
